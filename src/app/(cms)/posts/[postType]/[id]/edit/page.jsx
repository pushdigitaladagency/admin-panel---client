...
export default function EditPostPage() {
  ...
  if (postType === 'event') {
    initialData = {
      ...
      title: data.title || '',
      slug: data.slug || '',
      category: data.event_type_id ? String(data.event_type_id) : data.eventType?.id ? String(data.eventType.id) : '',
    ...
    initialData = {
      ...
      title: data.title || '',
      slug: data.slug || '',
      category: data.category_id ? String(data.category_id) : data.category?.id ? String(data.category.id) : '',
